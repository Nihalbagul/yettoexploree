...
function Card({
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-8 left-4 w-[76px] h-[76px] rounded-full overflow-hidden" style={{ marginBottom: "170px", marginLeft: "30px", backgroundColor: "#C2C6CC" }}>
    <img src={logo} alt="Logo" className="w-full h-full object-cover" />
</div>

<div className="absolute left-36 bottom-12 w-[272px] h-[76px]" style={{ marginBottom: "150px" }}>
