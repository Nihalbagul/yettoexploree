  ...
  return (
    <div className="w-full max-w-[382px] p-4 relative">
      ...
      <div className="relative w-[382px] h-[340px]">
        ...
        <div className="absolute bottom-2 left-2 text-sm font-medium font-montserrat " style={{color:"#9a9a9a"}}>
          {priceRange}
        </div>
      </div>
      ...
      <div className="flex mt-4 space-x-6 text-[#484848]">
        {details.map((detail, index) => (
          ...
          >
            {/* <FontAwesomeIcon icon={icons[index]} className="text-[#484848]" /> */}
...
function CollectionCard() {
  ...
  return (
    <div className="container mx-auto mt-12">
      <h2 className="text-3xl font-bold text-[#484848]">CHOOSE A COLLECTION</h2>
